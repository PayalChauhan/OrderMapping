...
(function($){
    ...
    $.activmap = {
        defaults: {
            ...
            lat: 51.9194,       //latitude of the center
            lng: 19.1451,       //longitude of the center
...
mycontent += '<div class="moreinfo_show">More Info</div>';
                    //Info window init
                   ...
                   // place.html = '<div class="activmap-place" id="activmap-place_'+i+'"><div class="one"><div><img ng-src="images/events_def.svg" alt="" width="44" src="images/events_def.svg"></div><div><h3>'+place.title+'</h3><p>'+place.address+'</p></div></div><div class="two"><a href="#">More Info</a></div></div>';

/*place.html = '<div class="activmap-place" id="activmap-place_'+i+'"><div class="map_dtl_row1"><div class="map_dtl_img"><div class="map_dtl_img_dflt"><div class="map_dtl_img_dflt_in"><img ng-src="images/events_def.svg" alt="" width="44" src="images/events_def.svg"></div></div></div><div class="map_dtl_txt"><h3>'+place.title+'</h3><p>'+place.address+'</p>
</div></div><div class="more_row"><p>More Info<i class="fa fa-chevron-right subs-a" style="margin-left:5px;"></i></p></div></div>';
  */                 

place.html = '<div class="my_sort" style="display: none;">'+place.title+'</div><div class="activmap-place main_result_box" id="activmap-place_'+i+'"><div class="map_dtl_row1"><div class="map_dtl_img"><div class="map_dtl_img_dflt"><div class="map_dtl_img_dflt_in"><img ng-src="images/events_def.svg" alt="" width="100%" src="../network/content/uploads/'+place.upic+'"></div></div></div><div id="'+place.uid+'" class="map_dtl_txt"><h3>'+place.title+'</h3><p>'+place.address+'</p></div></div><div class="more_row moreinfo_show"><p id="'+place.uid+'">More Info <i class="fa fa-chevron-right subs-a" style="margin-left:5px;"></i></p></div></div>'; 
